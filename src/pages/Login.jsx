...
const Login = () => {
  ...
  <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-lg p-8 shadow-lg">
    ...
    <div className="flex items-center justify-center gap-2 mb-6">
      ...
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white">MovieApp</h1>
    </div>
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        type="submit"
        className="w-full bg-red-600 text-white p-3 rounded font-semibold hover:bg-red-700 transition-colors"
      >
        Login
      </button>
    </form>
